...
{
    // Get a reference to the 2 dice s
    public GameObject dice1;
    public GameObject dice2;

    // Get a reference to the MainScreen and DiceScreen
    ...
    [HideInInspector] public int lumberCount;
    [HideInInspector] public int oreCount;
    [HideInInspector] public int grainCount;
    [HideInInspector] public int woolCount;
    ...
    private IEnumerator GiveResources()
    {
        ...
        // This displays the resource count to the console
        // However, this will later be changed to display in the UI instead
        Debug.Log("Brick count: " + brickCount);
        Debug.Log("Lumber count: " + lumberCount);
        Debug.Log("Ore count: " + oreCount);
        Debug.Log("Grain count: " + grainCount);
        Debug.Log("Wool count: " + woolCount);
